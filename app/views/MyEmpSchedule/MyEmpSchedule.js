...
import {View, Text, SafeAreaView, StatusBar, ScrollView, TouchableOpacity, Button, Alert, Image} from "react-native";
    ...
    return (
      ...
      >
        <View>
          ...
          <Text style={myEmpScheduleStyles.itemDurationText}>{item.duration}</Text>
        </View>
...
export default createAppContainer(MyEmpScheduleRouter);