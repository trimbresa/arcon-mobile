          ...
          return (
            <View
              style={[
                ...
                !props.approved && sectionItemStyles.sectionItemIconScheduleApproved
              ]}>
              <Ionicons
    ...
    >
      ...
      <View style={sectionItemStyles.sectionItemText}>
        <Text style={sectionItemStyles.sectionItemTextMain} numberOfLines={2}>
          <Text
            style={sectionItemStyles.sectionItemAuthor}
          >
            {`${props.author} `}
          </Text>
          <Text
            style={sectionItemStyles.sectionItemTitle}
          >
            {props.title}
          </Text>
        </Text>
              ...
              </Text>
              {
                !props.approved && (
                  <View style={sectionItemStyles.scheduleApprovalActions}>
                    ...
                    >
                      <Text style={sectionItemStyles.scheduleApprovalBtnLabel}>Approve</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                      style={[
                        sectionItemStyles.scheduleApprovalBtn,
                    ...
                    >
                      <Text style={sectionItemStyles.scheduleApprovalBtnLabel}>Reject</Text>
                    </TouchableOpacity>
                  </View>
                )
              }
